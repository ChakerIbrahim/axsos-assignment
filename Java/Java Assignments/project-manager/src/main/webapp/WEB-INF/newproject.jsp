...
<style>
	* { margin: 0; padding: 0; box-sizing: border-box; }
	...
	.submit { background: #ffb454; color: #0f0e17; }
...
<body>
	<div class="wrap">
		...
		<div class="panel">
			<div class="tag">//Create a Blog</div>
			<h1>Create a Blog</h1>

			<%-- Bound to the empty "project" object.
			     Validations: title provided (min 3), description min 3,
			     due date provided and in the future. --%>
			<form:form action="/projects" method="post" modelAttribute="project">
				<form:label path="title">Blog Title</form:label>
				<form:input path="title" />
				<form:errors path="title" cssClass="error" />

				<form:label path="category">Categoy</form:label>
				...
				<%-- Date picker: due date must be provided + in the future --%>
