...
<head>
	...
	<%-- Space Grotesk for headings, JetBrains Mono for small labels --%>
	...
	<style>
		* { margin: 0; padding: 0; box-sizing: border-box; }
		...
		body {
			...
			/* deep indigo-black with a faint amber glow at the top */
		...
		/* mono uppercase tag, like a code label */
		.tag {
		...
		h1 span { color: #ffb454; } /* amber accent word */

		.subtitle { color: #8f8ba3; margin-bottom: 48px; }
		...
		/* translucent dark panel with a glowing border */
		.panel {
			width: 400px;
		...
		/* the register panel glows amber, the login panel glows teal */
...
<div class="tag">// book club</div>
<h1>Shared <span>shelves</span>.</h1>
