...
public class User {
    ...
    // SECOND one-to-many: ONE user can be BORROWING many books.
    // mappedBy="borrower" maps this list to the "borrower" attribute
    // in the Book class (this is the second relationship of the
    // "multiple one-to-many" this assignment requires).
