...
public class Book {
    ...
    // SECOND many-to-one: MANY books can be borrowed by ONE user.
    // A separate foreign key column "borrower_id" stores who is
    // currently borrowing this book. When nobody is borrowing it,
    // borrower is null - that is how we know a book is "available".
    @ManyToOne(fetch = FetchType.LAZY)
